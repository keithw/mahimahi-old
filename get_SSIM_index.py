...
#Usage: python get_SSIM_index.py 'youtube_url' reference_video_path
...
def main():
	if len( sys.argv ) is not 3:
		raise ValueError("Usage: python get_SSIM_index.py 'youtube_url' reference_video_path")
	...
	if not match_object:
		...
		for filename in get_filenames_list("./media_files/" + video_id + "/video/"):
			...
			process_list += [subprocess.Popen("../SSIM/src/ssim " + reference_video_path + " " + filename + " > " + output_filename, shell=True)]
